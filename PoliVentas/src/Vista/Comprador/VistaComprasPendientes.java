...
public class VistaComprasPendientes implements Vista {
    ...
    private RadioButton  si, no; private Rating ratingVendedor, ratingProducto;
    private final TableView<Pedido> pedidos;
    private TableColumn<Pedido, String> colId,colPrecio,colCant,
            colFP,colFE,colLE,colV,colP;

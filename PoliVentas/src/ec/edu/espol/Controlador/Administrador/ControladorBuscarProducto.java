...
import ec.edu.espol.Vista.Administrador.VistaBuscarProducto;
import ec.edu.espol.Vista.Administrador.VistaInfoProducto;
...
public class ControladorBuscarProducto {
    ...
    private class ventanaPButtonHandler implements EventHandler {
        ...
        public void handle(Event event) {
            ...
            ControladorInfoProducto controladorInfoUsuario = new ControladorInfoProducto(a, v);
